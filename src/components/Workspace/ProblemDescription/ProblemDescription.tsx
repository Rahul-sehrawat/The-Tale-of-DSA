...
const ProblemDescription: React.FC<ProblemDescriptionProps> = ({ problem, _solved }) => {
	...
	return (
		<div className='bg-dark-layer-1  '>
			{/* TAB */}
			<div className='flex h-11  w-full items-center space-x-0.5 pt-2 bg-dark-layer-2 text-white overflow-x-hidden '>	
				<div className={"bg-dark-layer-1 flex  rounded-t-[5px] px-5 py-[10px] text-xs cursor-pointer space-x-1 items-center"}>
					<MdDescription  />
					<h1>Description</h1>
				</div>
				<TabButton/>
