...
const Discuss:React.FC<DiscussProps> = () => {
    ...
    return <body className=' h-full w-full bg-black overflow-auto'>
        <Topbar/>
        <h1 className='  text-orange-500  text-center text-3xl p-4 m-6 flex w-60  rounded-lg  bg-amber-200 border-green-400 border-4 '><b>📑Courses</b>  
        </h1>
